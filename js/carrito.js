 ...
 botonesCategorias.foreach (boton => {
	boton.addEventListener ("click", (e) => {
		...
		if (e.currentTarget.id != "todos") {
			const productoCategoria = items.find(allProducts =>
			items.titulo-item.id ===e.currentTarget.id);
			tituloPrincipal.innerText = productoCategoria.categoria.nombre;
			const productosBoton = items.filter (allProducts =>
				productoCategoria.categoria.id ===e.cuirrentTarget.id);
